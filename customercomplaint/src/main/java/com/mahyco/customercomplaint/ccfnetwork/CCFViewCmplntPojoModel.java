...
public class CCFViewCmplntPojoModel extends CCFBaseApiResponse {

    @SerializedName("returnval")
    public ReturnValue returnval;
    ...
    public class ReturnValue {
        ...
        private ArrayList<UpComingTrips> Table = new ArrayList<>();

        public ArrayList<UpComingTrips> getTable() {
            return Table;
        }

        public void setTable(ArrayList<UpComingTrips> Table) {
            this.Table = Table;
        }
...
//            @SerializedName("TotalLotQty")
//            private double TotalLotQty = 0;
//
//            @SerializedName("TotalNoOfPkts")
//            private int TotalNoOfPkts = 0;
