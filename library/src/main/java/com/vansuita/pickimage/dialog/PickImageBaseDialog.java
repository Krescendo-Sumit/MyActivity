...
public abstract class PickImageBaseDialog extends DialogFragment
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
       ...
       // View view = inflater.inflate(dialog, null, false);
        view = inflater.inflate(R.layout.dialogcapture, container,
                false);
    ...
    private void onBindViews(View v) {
       ...
       // tvGallery.setVisibility(View.INVISIBLE);
