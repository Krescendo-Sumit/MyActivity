...
public abstract class GalleryCameraPickImageBaseDialog extends DialogFragment
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        view = inflater.inflate(R.layout.dialog_gallery_camera, container,
                false);
    ...
    private void onBindViews(View v) {
        ...
        tvGallery.setVisibility(View.INVISIBLE); /* Remark 9th Sept 2021*/
    ...
    private void onBindViewListeners() {
        ...
        tvGallery.setOnClickListener(listener); /* Remark 9th Sept 2021*/
    }
    ...
    private void onSetup() {
        if (setup.getBackgroundColor() != android.R.color.white) {
            ...
            if (showGallery) /* Remark 9th Sept 2021*/
    ...
    protected GalleryCameraPickImageBaseDialog setOnPickResult(IPickResult onPickResult) {
        this.onPickResult = onPickResult;
        return this;
    }


    protected GalleryCameraPickImageBaseDialog setOnClick(IPickClick onClick) {
        this.onClick = onClick;
        return this;
    }


    protected GalleryCameraPickImageBaseDialog setOnPickCancel(IPickCancel onPickCancel) {
