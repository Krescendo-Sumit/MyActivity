...
public class ShellingDayActivity extends AppCompatActivity implements
    ...
    int farmerCount = 0;
    Prefs mPref;
    EditText et_numberoffarmer, et_numberofretailer;

    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);

        setContentView(R.layout.activity_shelling_day);
        ...
        spCropType.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                try {
                    ...
                    Toast.makeText(ShellingDayActivity.this, ex.toString(), Toast.LENGTH_LONG).show();
                }
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (validation()) {
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(ShellingDayActivity.this);
...
//        }
    ...
    public boolean validation() {
        ...
        String retailercount = et_numberofretailer.getText().toString().trim();
        String farmercount = et_numberoffarmer.getText().toString().trim();
        String LatLong = cordinates;
        String PhotoName = userCode + "_ShellingDay_" + Calendar.getInstance().getTimeInMillis() + ".jpg";
        ...
        if (finalvillage.equals("") || finalvillage.toLowerCase().contains("select")) {
            showAlert("Village Code Missing");
            return false;
        } else if (cropType.equals("") || cropType.toLowerCase().contains("select")) {
            showAlert("Crop Missing");
            return false;
        } else if (product.equals("") || product.toLowerCase().contains("select")) {
            showAlert("Product Missing");
            return false;
        } else if (retailercount.equals("")) {
            showAlert("Number of RetailerMissing");
            return false;
        } else if (farmercount.equals("")) {
 ...
 */
    ...
    public void saveToDb() {
        ...
        if (finalvillage.equals("")) {
            showAlert("Village Code Missing");
        } else if (cropType.equals("")) {
            showAlert("Crop Missing");
                                ...
                                public void onClick(DialogInterface dialogInterface, int id) {
                                    ...
                                    if (config.NetworkConnection()) {
                                        ...
                                        if (list.size() > 0) {
                                            ...
                                            new ShellingDayAndUtpadanMohatsavAPI(context, ShellingDayActivity.this).UploadShellingDay(jsonArray);
                                        }
                                    }
       ...
       /* if (config.NetworkConnection()) {
        ...
        } else*/
        {
            ...
            builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    Config.refreshActivity(ShellingDayActivity.this);
                    dialog.dismiss();
