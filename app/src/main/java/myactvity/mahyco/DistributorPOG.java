...
public class DistributorPOG extends AppCompatActivity {
    ...
    String  saleorg,customer, name , DLV_plant, customregroup, Distrcode;
    TextView lbltaluka;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_distributor_pog);
        ...
        btnPOG.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try
                {
                    ...
                    if (validation() == true) {
                        Intent intent = new Intent(context.getApplicationContext(), distributorpogupdateDetail.class);
        ...
        btnCompetitatorPOG.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try
                {
                    ...
                    if (validation() == true) {
                        Intent intent = new Intent(context.getApplicationContext(), distributorCompetitatorPOGupdate.class);
                        intent.putExtras(bundle);
                        startActivityForResult(intent, 1);
                    }
                    //intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
