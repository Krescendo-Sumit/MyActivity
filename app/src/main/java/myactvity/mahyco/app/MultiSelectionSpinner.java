...
public class MultiSelectionSpinner extends androidx.appcompat.widget.AppCompatSpinner
    ...
    private boolean hasRetailer = false;
        ...
        if (mSelection != null && which < mSelection.length) {
            if(hasRetailer)
            {
                if(hasNone) {
                    ...
                    }else   if (which == mSelection.length-1 && isChecked ) {
                    ...
                    else if (which < mSelection.length-1 && mSelection[mSelection.length-1] && isChecked) {
                        mSelection[mSelection.length-1] = false;
                        ((AlertDialog) dialog).getListView().setItemChecked(mSelection.length-1, false);
                    }
                }
...
//        });
    ...
    public void hasRetailerOption(boolean val){
        hasRetailer = val;
    }
