 ...
 */
public class ProjectorMeetingActivity extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks,
        GoogleApiClient.OnConnectionFailedListener, LocationListener, ResultCallback,
        IPickResult,View.OnClickListener{
    Context context;
    private static final String TAG = "ProjectMeeting";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_projector_meeting);
...
*/
        lblheader.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(ProjectorMeetingActivity.this, AndroidDatabaseManager.class);
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (validation()) {
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(ProjectorMeetingActivity.this);
...
//                                }
//                            });
                            uploadLivePlantDisplayVillageData("");
                         //   dowork();
...
//
//        String ss=uploadLivePlantDisplayVillageData("LivePlantDisplayVillageData");
//Log.i("Res in C",ss);
...
//    }
    ...
    public void LivePlantDisplayVillage(String LivePlantDisplayVillageData) {
       ...
       if (config.NetworkConnection()) {
            ...
            builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    Config.refreshActivity(ProjectorMeetingActivity.this);
                    dialog.dismiss();
                    relPRogress.setVisibility(View.GONE);
                    container.setClickable(true);
                    container.setEnabled(true);
    ...
    public void uploadLivePlantDisplayVillageData(String LivePlantDisplayVillage) {


/*
        userCode, uId, focussedVillage, state, district, taluka, othervillage, farmerCount, cropType,
                product, taggedCordinates +" "+ taggedAddress,
                taggedCordinates, activityImgName, activityImgPath, activityImgStatus,
                isSynced,villagecode
  */
        if (config.NetworkConnection()) {
            if (validation()) {
                ...
                try {
                    ...
                    jsonObject.put("VillageCategoty", villageCategory);
                    jsonObject.put("FocusVillage", focussedVillage);//: "string",
                    jsonObject.put("State", state);//: "string",
                    jsonObject.put("District", district);//: "string",
                    jsonObject.put("Taluka", taluka);//: "string",
                    jsonObject.put("Village", othervillage);//: "string",
                    jsonObject.put("Crop", cropType);//: "string",
                    jsonObject.put("Product", product);//: "string",
                    jsonObject.put("TotalNoOfFarmers", Integer.parseInt(farmerCount));//: 0,
                    jsonObject.put("coordinates", taggedCordinates);//: "string",
                    jsonObject.put("taggedAddress", taggedAddress);//: "string",
                    jsonObject.put("UploadActivityPhoto", mDatabase.getImageDatadetail(Imagepath1));//: "string",
                    jsonObject.put("VillageCode", villagecode);//: "string",
                    jsonObject.put("entryDate", formattedDate);//: "2023-03-28T22:10:18.576Z",
                    jsonObject.put("CreatedBy", userCode);//: "string",
                    jsonObject.put("CreatedDt", formattedDate);//: "2023-03-28T22:10:18.576Z"
                    Log.i("Json Request", jsonObject.toString());
                    globalJson = jsonObject;
                    new SaveData().execute();
                    //  str = syncLivePlantDisplayVillageDataSingleImage(jsonObject);
        ...
        {
            new AlertDialog.Builder(context).setTitle("Network Message")
    ...
    public synchronized String syncLivePlantDisplayVillageDataSingleImage(JSONObject jsonObject) {
    ...
    private class SaveData extends AsyncTask<String, Void, Void> {
        ...
        private ProgressDialog Dialog = new ProgressDialog(ProjectorMeetingActivity.this);
        private String type = "";
