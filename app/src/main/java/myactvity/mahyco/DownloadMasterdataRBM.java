...
public class DownloadMasterdataRBM extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_download_masterdata_rbm);
        getSupportActionBar().hide(); //<< this
        setTitle("Download Master Data RBM");
        ...
        context= DownloadMasterdataRBM.this;
           ...
           /* if (recordshowCoupon() > 0) {
            ...
            else*/
            {
                if (config.NetworkConnection()) {
                    ...
                    lblmsg.setText("Master data downloading on process ..3");
                    try {
                        new MDOMyplotDataDownload(1, userCode, DownloadMasterdataRBM.this, "result").execute(MDOurlpath);
           ...
           /* if (recordshowCoupon() > 0) {
            ...
            else*/
            {
                if (config.NetworkConnection()) {
                    ...
                    lblmsg.setText("Master data downloading on process ..3");
                    try {
                        new MDOCouponSchemeDataDownload(1, userCode, DownloadMasterdataRBM.this, "result").execute(MDOurlpath);
...
*/
                    ...
                    try {
                        ...
                        new MDOMasterData(5, uid, "", DownloadMasterdataRBM.this).execute(MDOurlpath);
