...
public class saleOrderReturnApproved extends AppCompatActivity {
    // List view
    ProgressDialog pd;
    private ListView lv;
    Config config;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sale_order_return_approved);
    ...
    private void BindFarmerlistData( String search,String action)
    {
        ...
        if (config.NetworkConnection()) {
            ...
            new Salereturnorderdata("","3",objAsBytes,usercode,"","","",search,"","").execute();
          }
        else
        {
        ...
        try {
            ...
            try {
                ...
                if(jArray.length()==0 )
                {
                    ...
                    lblList.setText(" sale return order list not available");
    ...
    public void  CallPage(String grcode,String grname)
    {
        ...
        {
            intent = new Intent(saleOrderReturnApproved.this,salesreturnorderlist.class);
    ...
    public class Salereturnorderdata extends AsyncTask<String, String, String> {
        ...
        private String usercode,saleorg,division,customer,Comments,
                returnstring,action,cmbDistributor,DLV_plant,name,customregroup,orderid,lotno;
        byte[] objAsBytes;
