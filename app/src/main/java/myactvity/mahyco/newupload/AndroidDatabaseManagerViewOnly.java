...
public class AndroidDatabaseManagerViewOnly extends Activity implements OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dbm = SqliteDatabase.getInstance(this);
        mainscrollview = new ScrollView(AndroidDatabaseManagerViewOnly.this);
        ...
        mainLayout = new LinearLayout(AndroidDatabaseManagerViewOnly.this);
        ...
        final LinearLayout firstrow = new LinearLayout(AndroidDatabaseManagerViewOnly.this);
        firstrow.setPadding(0,10,0,20);
        LinearLayout.LayoutParams firstrowlp = new LinearLayout.LayoutParams(0, 150);
        firstrowlp.weight = 1;

        TextView maintext = new TextView(AndroidDatabaseManagerViewOnly.this);
        maintext.setText("Select Table");
        maintext.setTextSize(22);
        maintext.setLayoutParams(firstrowlp);
        select_table=new Spinner(AndroidDatabaseManagerViewOnly.this);
        ...
        hsv = new HorizontalScrollView(AndroidDatabaseManagerViewOnly.this);

        //the main table layout where the content of the sql tables will be displayed when user selects a table
        tableLayout = new TableLayout(AndroidDatabaseManagerViewOnly.this);
        tableLayout.setHorizontalScrollBarEnabled(true);
        hsv.addView(tableLayout);

        //the second row of the layout which shows number of records in the table selected by user
        final LinearLayout secondrow = new LinearLayout(AndroidDatabaseManagerViewOnly.this);
        ...
        TextView secondrowtext = new TextView(AndroidDatabaseManagerViewOnly.this);
        secondrowtext.setText("No. Of Records : ");
        secondrowtext.setTextSize(20);
        secondrowtext.setLayoutParams(secondrowlp);
        tv =new TextView(AndroidDatabaseManagerViewOnly.this);
        tv.setTextSize(20);
        ...
        final Button submitQuery = new Button(AndroidDatabaseManagerViewOnly.this);
        ...
        final TextView help = new TextView(AndroidDatabaseManagerViewOnly.this);
        ...
        final Spinner spinnertable =new Spinner(AndroidDatabaseManagerViewOnly.this);
        ...
        final LinearLayout thirdrow = new LinearLayout(AndroidDatabaseManagerViewOnly.this);
        previous = new Button(AndroidDatabaseManagerViewOnly.this);
        previous.setText("Previous");

        previous.setBackgroundColor(Color.parseColor("#BAE7F6"));
        previous.setLayoutParams(secondrowlp);
        next = new Button(AndroidDatabaseManagerViewOnly.this);
        next.setText("Next");
        ...
        tvmessage =new TextView(AndroidDatabaseManagerViewOnly.this);
        ...
        final Button customQuery = new Button(AndroidDatabaseManagerViewOnly.this);
        ...
        ArrayAdapter<String> tablenamesadapter = new ArrayAdapter<String>(AndroidDatabaseManagerViewOnly.this,
        ...
        select_table.setOnItemSelectedListener(new OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent,
                ...
                if(pos!=0){
                    ...
                    ArrayAdapter<String> adapter = new ArrayAdapter<String>(AndroidDatabaseManagerViewOnly.this,
                    ...
                    if(c2!=null)
                    {
                        ...
                        spinnertable.setOnItemSelectedListener((new OnItemSelectedListener() {
                            ...
                            public void onItemSelected(AdapterView<?> parentView, View selectedItemView, int position, long id) {
                                    ...
                                    runOnUiThread(new Runnable() {
                                        ...
                                        public void run() {
                                            if(!isFinishing()){
                                                ...
                                                new AlertDialog.Builder(AndroidDatabaseManagerViewOnly.this)
                                ...
                                if(spinnertable.getSelectedItem().toString().equals("Add row to this table"))
                                {
                                    ...
                                    final ScrollView addrowsv =new ScrollView(AndroidDatabaseManagerViewOnly.this);
                                    ...
                                    final RelativeLayout addnewlayout = new RelativeLayout(AndroidDatabaseManagerViewOnly.this);
                                    ...
                                    for(int i=0;i<addnewrownames.size();i++)
                                    {
                                        ...
                                        et.setId(k);
                                        final LinearLayout ll = new LinearLayout(AndroidDatabaseManagerViewOnly.this);
                        ...
                        {
                            LinearLayout cell = new LinearLayout(AndroidDatabaseManagerViewOnly.this);
    ...
    public void updateDeletePopup(int row)
    {
        ...
        final RelativeLayout lp = new RelativeLayout(AndroidDatabaseManagerViewOnly.this);
        lp.setBackgroundColor(Color.WHITE);
        RelativeLayout.LayoutParams lay = new RelativeLayout.LayoutParams(RelativeLayout.LayoutParams.WRAP_CONTENT, RelativeLayout.LayoutParams.WRAP_CONTENT);
        lay.addRule(RelativeLayout.ALIGN_PARENT_TOP);

        final ScrollView updaterowsv =new ScrollView(AndroidDatabaseManagerViewOnly.this);
        LinearLayout lcrud = new LinearLayout(AndroidDatabaseManagerViewOnly.this);
        ...
        ArrayAdapter<String> crudadapter = new ArrayAdapter<String>(AndroidDatabaseManagerViewOnly.this,
    ...
    public void paginatetable(final int number)
    {
        ...
        previous.setOnClickListener(new OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                int tobestartindex=(indexInfo.currentpage-2)*100;
