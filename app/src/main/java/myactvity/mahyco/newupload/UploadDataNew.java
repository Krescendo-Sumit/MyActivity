...
//done
    ...
    public void uploadRetailerSurveyData(String functionName, String paramKey) {
        if (config.NetworkConnection()) {
            dialog = new ProgressDialog(UploadDataNew.this);
    ...
    public class UploadImageData extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                if (resultout.contains("True")) {
                    // msclass.showMessage("Data uploaded successfully.");
                    Toast.makeText(UploadDataNew.this,"Image Upload : "+resultout,Toast.LENGTH_SHORT).show();
    ...
    public void downloadphotopath(String mdo_photoupdate) {
        if (config.NetworkConnection()) {
            ...
            try {
                ...
                new MDOMasterData(6, uid, "", UploadDataNew.this).execute(cx.MDOurlpath);
            } catch (Exception ex) {
                ...
                try {
                    ...
                    if (jsonVersionDetails.getBoolean("success")) {
                        ...
                        if (jsonVersionDetails.getInt("UserStatus") == 0) {
                            ...
                            new AlertDialog.Builder(UploadDataNew.this)
                                    ...
                                    .setPositiveButton("Login Again", new DialogInterface.OnClickListener() {
                                        ...
                                        public void onClick(DialogInterface dialog, int which) {
                                            ...
                                            //System.exit(0);
                                            logLogOutEvent();
                                            Intent intent = new Intent(UploadDataNew.this, LoginActivity.class);
                                            intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                                            startActivity(intent);
                                        }
                                    })
