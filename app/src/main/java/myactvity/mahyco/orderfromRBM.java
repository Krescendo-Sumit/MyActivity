...
public class orderfromRBM extends AppCompatActivity {

    ProgressDialog pd;
    public EditText txtIrrigationdt,txtirrigation,
            txtQty,txtComments,txtReason;
    public SearchableSpinner spproductlist,spdistributor,spdistributorshipto,spdivision,spsaleorg,spTBM,spdepot;
    public Messageclass msclass;
    public CommonExecution cx;
    String division,usercode,org, cmbDistributor,TBMcode,cmbDistributorshipto;
    ...
    String  saleorg,customer, name , DLV_plant, customregroup,cmbproductlist,shiptocustomer;
    TextView txttotalvalue,lbldistributorShipto;
    int check2=0;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_orderfrom_rbm);
        ...
        spsaleorg.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                try {
                    ...
                    GeneralMaster tm = (GeneralMaster) spTBM.getSelectedItem();
                    TBMcode=URLEncoder.encode(tm.Code().toString(), "UTF-8");
                    new Getdistributor("1",TBMcode,org,division,cmbDistributor).execute();
        ...
        spdistributor .setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                try {
                    ...
                    new Getdistributor("2",TBMcode,org,division,cmbDistributor).execute();
        ...
        btnsave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    if (tm.Code().equals("0"))
                    {
                        msclass.showMessage("Please select TBM Name.") ;
                        return ;
                    }
                    ...
                    if (txtReason.getText().length()==0) {
                        msclass.showMessage("Please enter order creation reason.(on the behalf of TBM.)");
                        return;
                    }
                    if (config.NetworkConnection())
                    {
                        ...
                        try {
                            ...
                            reason=URLEncoder.encode(txtReason.getText().toString(), "UTF-8");
                        } catch (UnsupportedEncodingException e) {
                            e.printStackTrace();
                        }

                        new Saleorderdata("1",objAsBytes,TBMcode,org,division,customer,name,
                                DLV_plant,customregroup,Comments,
                                shiptocustomer,reason).execute();
    ...
    public void callTBM()
    {
        // Action 6 get TBM list as per RBM code
        byte[] objAsBytes = new byte[1];
        //objAsBytes = mainObj.toString().getBytes("UTF-8");
        new Saleorderdata("6",objAsBytes,usercode,org,division,customer,name,DLV_plant,customregroup,"na","na","na").execute();
    ...
    public class Saleorderdata extends AsyncTask<String, String, String> {
        ...
        private String usercode,saleorg,division,customer,
                returnstring,action,cmbDistributor,DLV_plant,name,customregroup,
                Comments,shiptocustomer,reason;
        byte[] objAsBytes;
        ...
        public Saleorderdata( String action,byte[] objAsBytes, String usercode,String saleorg,
                              ...
                              String shiptocustomer, String reason  ){
