...
public class pogDashboard extends AppCompatActivity {
    private Context context;
    Button btnretailerPOG,btndistributorPOG,btndistributorasRetailerPOG;
    Config config;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pog_dashboard);
        ...
        editor = pref.edit();
        logPOGData();
        btnretailerPOG=(Button)findViewById(R.id.btnretailerPOG);
        btndistributorPOG=(Button)findViewById(R.id.btndistributorPOG);
        btndistributorasRetailerPOG=(Button)findViewById(R.id.btndistributorasRetailerPOG);

        btndistributorasRetailerPOG.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                try
                {
                    // 2 as rbm 4 as TBM
                    if (pref.getString("RoleID",null).equals("2") || pref.getString("RoleID",null).equals("4")) {
                        Intent intent = new Intent(context.getApplicationContext(), DistributorAsRetailerPOG.class);
        ...
        btnretailerPOG.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                try
                {
                    /*if(config.NetworkConnection()) {
                        ...
                        // Uploaded POG DATA
                        new SyncPOGData_Async("MDO_POGData","Retailer1").execute();

                        Intent intent = new Intent(context.getApplicationContext(), RetailerPOG.class);
                        intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                        context.startActivity(intent);
                    }
                    else*/
                        ...
                        if (pref.getString("unit", null).contains("VCBU"))
                        {
                            ...
                            {
                                intent = new Intent(context.getApplicationContext(),RetailerPOGVeg.class);
                                intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                                context.startActivity(intent);
                            }
                            else
                        ...
                        {
                            if (pref.getString("RoleID",null).equals("0"))//  || pref.getString("RoleID",null).equals("4")  )
                            {
        ...
        btndistributorPOG.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                try
                {
                   /* if(config.NetworkConnection()) {
                        ...
                        new SyncPOGData_Async("MDO_POGData", "Distributor2").execute();
                        Intent intent = new Intent(context.getApplicationContext(), DistributorPOG.class);
                        intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                        context.startActivity(intent);
                    }
                    else */
                    ...
                    if (pref.getString("RoleID",null).equals("2") || pref.getString("RoleID",null).equals("4")) {
                        ...
                        if (pref.getString("unit", null).contains("VCBU"))
                         {
                              intent = new Intent(context.getApplicationContext(),DistributorPOGVeg.class);
                         }
                         else
                         {
        ...
        if (pref.getString("unit", null).contains("VCBU"))
        {
            btndistributorasRetailerPOG.setVisibility(View.GONE);
        }
    }
