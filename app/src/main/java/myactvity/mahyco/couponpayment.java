...
public class couponpayment extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener, PaymentResultWithDataListener {
    ...
    public static final String TAG = "couponpayment";
    /**
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        activity = this;
        setContentView(R.layout.activity_couponpayment);
    ...
    public void onPaymentSuccess(String razorpayPaymentID, PaymentData data) {
        try {
            ...
            if (data != null) {
                ...
                new FinalOrderServerResponse(2, "orderCompletion", "success", "", "", error.toString(), data.getPaymentId(), data.getData().toString()).execute();
                    ...
                    if (rzp_payment_status.contains("failed")) {
                        ...
                        try {
                            if (Checkout.NETWORK_ERROR == Integer.parseInt(errorcode)) {
                                ...
                                Toast.makeText(couponpayment.this, "Payment failed: NETWORK_ERROR", Toast.LENGTH_SHORT).show();
                                ...
                                Toast.makeText(couponpayment.this, "Payment failed: CANCELLED", Toast.LENGTH_SHORT).show();
                                Utility.showAlertDialog("Payment failed: CANCELLED", response, context);


                            } else if (Checkout.TLS_ERROR == Integer.parseInt(errorcode)) {

                                Toast.makeText(couponpayment.this, "Payment failed: TLS_ERROR", Toast.LENGTH_SHORT).show();
                                Utility.showAlertDialog("Payment failed: TLS_ERROR", result, context);


                            } else {
                                Toast.makeText(couponpayment.this, "Payment failed: " + Integer.parseInt(errorcode) + " " + response, Toast.LENGTH_SHORT).show();
    ...
    public void setListData() {
        ...
        list = (ListView) findViewById(R.id.list);
        if (adapter == null) {
            adapter = new CustomAdapter(couponpayment.this, farmerPaymentModelArrayList, res);
    ...
    public void onRefresh() {
        ...
        if (config.NetworkConnection())
            ...
            Toast.makeText(couponpayment.this, "No Internet is available", Toast.LENGTH_SHORT).show();
        }
    ...
    private class GetFarmerData extends AsyncTask<String, String, String> {
        ...
        String Offline;
        private int action;
        AlertDialog.Builder builder = new AlertDialog.Builder(couponpayment.this);
        ...
        protected void onPreExecute() {
            ...
            pd = new ProgressDialog(couponpayment.this);
            pd.setTitle("Processing...");
            pd.setMessage("Please wait.");
            pd.setCancelable(true);
            pd.setProgressStyle(ProgressDialog.STYLE_SPINNER);
...
//    Intent intent = new Intent(getApplicationContext(), PaymentCompletionActivity.class);
//            intent.putExtra("usercode", usercode);
//            intent.putExtra("rzpPaymentId", razorpayPaymentID);
//            intent.putExtra("farmersIdList", farmerListJsonArray.toString());
//            intent.putExtra("status", "1");
//
...
//    public void insertIntoDb(String razorpayPaymentID, String amount) {
//        try {
//
//            mDatabase.insertPaymentTable(usercode, razorpayPaymentID, farmerListJsonArray, "1", amount);
//
//        } catch (Exception e) {
//            e.printStackTrace();
//        }
