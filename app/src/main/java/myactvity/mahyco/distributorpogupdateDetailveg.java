...
public class distributorpogupdateDetailveg extends AppCompatActivity {
    ProgressDialog pd;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_distributorpogupdate_detailveg);
      ...
      */
        ...
        spCropType.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                {
                    Toast.makeText(distributorpogupdateDetailveg.this,ex.toString(),Toast.LENGTH_LONG).show();
                }
            ...
            public void onNothingSelected(AdapterView<?> arg0) {
                Toast.makeText(distributorpogupdateDetailveg.this, "gngvnv", Toast.LENGTH_LONG).show();
            }
        });
    ...
    public void UpdateRetailerPOG()
    {
        try {
            ...
            for (int i = 1; i < my_linear_layout1.getChildCount(); i++) {
                ...
                final  EditText lblsoldtofarmer = (EditText) view2.findViewById(R.id.lblsoldtofarmer);
                ...
                jo.put("Mobileno", RetailerMobileno);
                jo.put("CropName", crop.trim());
                jo.put("ProductName", txtprdname.getText().toString());
                jo.put("CropCode", Crop_Code);
                jo.put("ProductCode", txtprdcode.getText().toString().trim());
                jo.put("plan", lblplan.getText().toString());
                jo.put("RecStockdepot", lblreceivedfrmdepo.getText().toString());
                jo.put("RecStockdistr","0");
                jo.put("ShiftStockToDistr", "0");
                jo.put("NetStock", "0");
                jo.put("placementstock", lblplacement.getText());
                jo.put("BalStock", lblbalgoddown.getText().toString());
                jo.put("soldToFarmer", lblsoldtofarmer.getText().toString());
                jo.put("stockDate", strdate);
                jo.put("Status", "0");
                jo.put("DistrCode", DistrCode);
            ...
            if (count > 0) {
                 ...
                 try
                {
                    ...
                    requestary.put("Type","VegDistributorPOGDatatest");
                    JSONArray jaheader = new JSONArray();
                    jaheader.put(requestary) ;

                    String searchQuery = "select * from DistributorNextBtPOGTable where Status='0'";
                    ...
                    new VegPOG("VegDistributorPOGDatatest", requestParams).execute();
     ...
     */
    private class VegPOG extends AsyncTask<String, String, String> {
        ProgressDialog pd;
        String function;

        JSONObject obj;

        public VegPOG(String function, JSONObject obj) {
               ...
               // msclass.showMessage(resultout);
                if (resultout.contains("True")) {
                 ...
                 /* if(jsonObject.has("message") && jsonObject.getString("message").equals("No activities found"))
                    ...
                    {
                        androidx.appcompat.app.AlertDialog.Builder builder = new androidx.appcompat.app.AlertDialog.Builder(distributorpogupdateDetailveg.this);
                    ...
                    builder.setMessage("Something went wrong please try again later."+result);
                    builder.setCancelable(false);
                    builder.setPositiveButton("Ok", new DialogInterface.OnClickListener()
                    {
                ...
                androidx.appcompat.app.AlertDialog.Builder builder = new androidx.appcompat.app.AlertDialog.Builder(distributorpogupdateDetailveg.this);
                builder.setTitle("Info");
                builder.setMessage("Something went wrong please try again later."+e.toString());
                builder.setCancelable(false);
                builder.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
...
*/
                ...
                //HEADER START
                final View view1 = LayoutInflater.from(this).inflate(R.layout.showupdatedistributorpogveg, null);
 ...
 */
                ...
                // Sold To Farmer
                lblsoldtofarmer.setText("SOLD TO FARMERS/POG");
                ...
                if(jArray.length()>0) {
                    for (int i = 0; i < jArray.length(); i++) {
                        ...
                        final View view2 = LayoutInflater.from(this).inflate(R.layout.showupdatedistributorpogveg, null);
                       ...
                       // final EditText lblnetstock1 = (EditText) view2.findViewById(R.id.lblnetstock);
                        ...
                        final TextView lblsoldtofarmer1 = (TextView) view2.findViewById(R.id.lblsoldtofarmer);

                        lblreceivedfrmdepo1.setFilters(new InputFilter[]{new DecimalDigitsInputFilter()});
                        lblplan1.setFilters(new InputFilter[]{new DecimalDigitsInputFilter()});
                            ...
                            public void onClick(View v) {
                                if (lblbalgoddown1.getText().length() == 0) {
                                    ...
                                    addproduct(croptype, txtprdcode1.getText().toString(), txtprdname1.getText().toString(),
                                            lblbalgoddown1.getText().toString());
                       ...
                       // lblnetstock1.setText(jObject.getString("NetStock").toString());
                        ...
                        lblsoldtofarmer1.setText(jObject.getString("soldToFarmer").toString());
                        //if(txtpridate.getText().length() ==0)
                        ...
                        if (listenForChanges)
                        {
                            ...
                            if (lblreceivedfrmdepo1.getText().length() != 0) { //do your work here }
                               /* if (lblreceivedfrmdistr1.getText().length() == 0) {
                                ...
                                double cont = Double.valueOf(lblreceivedfrmdepo1.getText().toString());
                                double bal = Double.valueOf(cont);// - Integer.valueOf(lblshipttodistr1.getText().toString());

                                double vv = Double.valueOf(bal) - Double.valueOf(lblbalgoddown1.getText().toString());

                                 // lblplacement1.setText(String.valueOf(vv));
                                //lblsoldtofarmer1.setText(String.valueOf(vv));
                                    ...
                                    if (listenForChanges) {
                                        ...
                                        if (s.length() != 0) { //do your work here }
                                            if (lblbalgoddown1.getText().length() != 0) {
                                                ...
                                                if (lblplacement1.getText().length() == 0) {
                                                    lblplacement1.setText("0");
                                                }


                                                double bal = Double.parseDouble(String.valueOf(s));
                                                placement = Double.parseDouble(String.valueOf(lblplacement1.getText()));
                                                bal=bal+placement;
                                                double receivedstock = Double.parseDouble(String.valueOf(lblreceivedfrmdepo1.getText()));

                                                if (bal > receivedstock) {
                                                    msclass.showMessage("goddown balance stock and  retailer placement total  should not more than net received stock.");
                                                    int cont = Integer.valueOf(lblreceivedfrmdepo1.getText().toString());
                                                   ...
                                                   // lblnetstock1.setText(String.valueOf(cont));
                                                    ...
                                                    double cont = Double.valueOf(receivedstock) - Double.valueOf(bal);


                                                    lblsoldtofarmer1.setText(String.valueOf(cont));
                                                   // int soldtofarm=bal-cont;
                                                    //lblsoldtofarmer1.setText(String.valueOf(soldtofarm));
                                                    //lblsoldtofarmer1.setText("0");
                                                }
                                            }
                        ...
                        lblplacement1.addTextChangedListener(new TextWatcher() {

                            public void onTextChanged(CharSequence s, int start, int before,
                                                      int count) {
                                try {
                                    double  godwnbalance=0;
                                    double  placement=0;
                                    if (listenForChanges) {
                                        listenForChanges = false;
                                        if (s.length() != 0) { //do your work here }
                                            if (lblsoldtofarmer1.getText().length() != 0) {
                                                ...
                                                double bal = Double.parseDouble(String.valueOf(s));
                                                double soldtofarmer = Double.parseDouble(String.valueOf(lblsoldtofarmer1.getText()));
                                                godwnbalance = Double.parseDouble(String.valueOf(lblbalgoddown1.getText()));
                                                bal=bal+godwnbalance;
                                                double receivedstock = Double.parseDouble(String.valueOf(lblreceivedfrmdepo1.getText()));

                                                if (bal > receivedstock) {
                                                    msclass.showMessage("sold to farmer stock and godown stock should not more than net received stock.");
                                                    int cont = Integer.valueOf(lblreceivedfrmdepo1.getText().toString());
