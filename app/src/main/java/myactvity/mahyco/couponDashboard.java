...
public class couponDashboard extends AppCompatActivity {
    private Context context;
    Button btndistribution, btncouponpayment, btnCouponPaymentHistory,btndAdvanceBooking;
    Config config;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // mDatabase.open();
        ...
        btncouponpayment = (Button) findViewById(R.id.btncouponpayment);
        btnCouponPaymentHistory = (Button) findViewById(R.id.btncouponpaymentHistory);
        btndAdvanceBooking = (Button) findViewById(R.id.btndAdvanceBooking);
            ...
            public void onClick(View v) {
                try {
                    if (config.NetworkConnection()) {
                        ...
                        Intent intent = new Intent(context.getApplicationContext(), coupondistribution.class);
        ...
        btndAdvanceBooking.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View view) {
               ...
               //if (5 > 0)
                ...
                if (mDatabase.getCountDt("couponMaster") > 0)

                   // if (mDatabase.getrowcount("select * from couponMaster") > 0)
                {
                //if (mDatabase.getrowcount("select * from couponMaster where strftime( '%Y-%m-%d', entryDate)='"+strdate+"'") > 0)
            ...
            public void onClick(View v) {
                try {
                    if (config.NetworkConnection()) {
                        ...
                        Intent intent = new Intent(context.getApplicationContext(), couponpayment.class);
                        intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                        context.startActivity(intent);
                    } else {
            ...
            public void onClick(View v) {
                try {
                    ...
                    if (config.NetworkConnection()) {
                        ...
                        Intent intent = new Intent(couponDashboard.this, PaymentHistoryActivity.class);
                        intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                        context.startActivity(intent);
                    } else
                        {
