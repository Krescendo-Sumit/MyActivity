...
public class VillageMeetingActivityOnline extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_village_meeting_online);
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (validation()) {
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(VillageMeetingActivityOnline.this);
        ...
        spRetailerDetails.setListener(new MultiSelectionSpinner.MySpinnerListener() {
            ...
            public void selectedStrings(List<String> strings) {
                ...
                if (String.valueOf(strings).contains("OTHER") ||
                    ...
                    editor.commit();
                    intent = new Intent(VillageMeetingActivityOnline.this, RetailerandDistributorTag.class);
                    intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                    startActivity(intent);
...
//        }
    ...
    public void bindFocussedVillages() {
        ...
        try {
            ...
            Cursor cursor;
            //searchQuery = "SELECT distinct vil_desc,vil_code  FROM FocussedVillageMaster " +
...
//                        "SELECT MDO / SO"));
    ...
    public void saveToDb() {
        ...
        final String activityImgName = "VillageMeetingPhoto" + pref.getString("UserID", null) + String.valueOf(entrydate.getTime());
    ...
    public void uploadData(String VillageMeetingData) {
       ...
       /* if (config.NetworkConnection()) {
            ...
            builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    Config.refreshActivity(VillageMeetingActivityOnline.this);
                    dialog.dismiss();
                    relPRogress.setVisibility(View.GONE);
                    container.setClickable(true);
                    container.setEnabled(true);
            ...
            try {
                ...
                if (jsonObject.has("success")) {
                    if (Boolean.parseBoolean(jsonObject.get("success").toString())) {
                        ...
                        androidx.appcompat.app.AlertDialog.Builder builder = new androidx.appcompat.app.AlertDialog.Builder(VillageMeetingActivityOnline.this);
                        builder.setTitle("MyActivity");
    ...
    public void bindVillageOnline(String result ) {
        ...
        try {
            ...
            for (int i = 0; i < jArray1.length(); i++) {
                ...
                focussedVillageList.add(new GeneralMaster(jObject.getString("vil_desc").toString(),
