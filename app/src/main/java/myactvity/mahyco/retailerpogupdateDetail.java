...
public class retailerpogupdateDetail extends AppCompatActivity {
    ...
    String state,dist,taluka,mktplace,RetailerMobileno,RetailerName,RetailerType;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_retailerpogupdate_detail);
        ...
        spCropType.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onNothingSelected(AdapterView<?> arg0) {
                Toast.makeText(retailerpogupdateDetail.this, "gngvnv", Toast.LENGTH_LONG).show();
            }
        });
            ...
            try {
                ...
                for (int i = 1; i < my_linear_layout1.getChildCount(); i++) {
                   ...
                   /* if(lblreceived1.getText().length()>1 &&
                            ...
                            lblnetstock1.getText().length()!=0)*/
                  if(lblreceived1.getText().length()>0 && Integer.valueOf(lblreceived1.getText().toString())>0&&
                          lblnetstock1.getText().length()!=0)
                  
                  {
                          boolean f=false;

                            f = mDatabase.InsertRetailerPOGData(pref.getString("UserID", null),
                                   state, dist, taluka, mktplace,RetailerName, RetailerMobileno,
                                   ...
                                   lblnetstock1.getText().toString(), lblsoldtofarmer1.getText().toString(),
                ...
                if (count > 0) {
                   ...
                   // new SyncPOGData_Async("MDO_POGData","DistributorAsRetailer3").execute();
                    new SyncPOGData_Async("MDO_RetailerPOGData","DistributorAsRetailer3").execute();


                } else {
                    msclass.showMessage("Please enter atleast one product received quantity.");
                }
           ...
           //st
            try {
               ...
               /* String searchQuery = "SELECT distinct a.Prod_Name as ProductName, a.Crop_Name as CropName,  " +
                ...
                //HEADER START
                final View view1 = LayoutInflater.from(this).inflate(R.layout.showupdatepog, null);
              ...
              // ViewGroup.LayoutParams params = txtprdname.getLayoutParams();
               ...
               // ViewGroup.LayoutParams params3 = lblshipt.getLayoutParams();
               // params3.height  = 100;

               /// lblshipt.setGravity(Gravity.CENTER);
                //lblshipt.setLayoutParams(params3);
                lblshipt.setFilters(new InputFilter[] {new InputFilter.LengthFilter(30)});
                lblshipt.setText("STOCK SHIFTED/SOLD TO OTHER");// STOCK");
                ...
                //lblshipt.setBackgroundColor(getResources().getColor(R.color.redbus));
                // lblcrop.setTextSize(14);
                lblshipt.setTypeface(lblshipt.getTypeface(), Typeface.BOLD);

               // ViewGroup.LayoutParams params4 = lblnetstock.getLayoutParams();
                //params4.height  = 100;
               // lblnetstock.setGravity(Gravity.CENTER);
                //lblnetstock.setLayoutParams(params4);
                lblnetstock.setFilters(new InputFilter[] {new InputFilter.LengthFilter(30)});
               ...
               // lblnetstock.setHeight(55);

                lblnetstock.setTextColor(Color.WHITE);
                lblnetstock.setBackgroundColor(Color.TRANSPARENT);

                //  lblnetstock.setBackgroundColor(getResources().getColor(R.color.redbus));
                                        ...
                                        if (s.length() != 0) { //do your work here }
                                            if (lblshipt1.getText().length() != 0) {
                                                ...
                                                if (shiftstock > receivestock) {
                                                    msclass.showMessage("Shift to other stock should not more than received stock.");
                                                    lblshipt1.setText("");
                                                    lblnetstock1.setText("0");
                                                    lblsoldtofarmer1.setText("");
                                                    lblbal1.setText("0");
                                    ...
                                    if (listenForChanges) {
                                        ...
                                        if (s.length() != 0) { //do your work here }
                                            ...
                                            if (soldtofarmer > netstock) {
                                                msclass.showMessage("sold to farmer stock should not more than net stock.");
                                                lblsoldtofarmer1.setText("");
                                                lblbal1.setText("0");
                                            } else {
