 ...
 */
public class RetailerVisitsActivity extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks,
 ...
 //   String SERVER = "https://cmr.mahyco.com/MDOHandler.ashx";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_retailer_visits);
    ...
    private void initUI() {
        ...
        lblheader.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(RetailerVisitsActivity.this, AndroidDatabaseManager.class);
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (validation()) {
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(RetailerVisitsActivity.this);
