 ...
 */
public class DistributerVisitsActivityOnline extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks,
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_distributer_visits_online);
    ...
    private void initUI() {
        ...
        lblheader.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(DistributerVisitsActivityOnline.this, AndroidDatabaseManager.class);
                ...
                try {
                    ...
                    if (distributerList != null) {
                        if (position ==  1) {
                            ...
                            editor.commit();
                            intent = new Intent(DistributerVisitsActivityOnline.this, RetailerandDistributorTag.class);
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (validation()) {
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(DistributerVisitsActivityOnline.this);
...
//        }
    ...
    public void bindDistributorOnline(String result ) {
        String[] array;
        ...
        try {
            ...
            try {
                ...
                for (int i = 0; i < jArray.length(); i++) {
                    JSONObject jObject = jArray.getJSONObject(i);
                    distributerList.add(new GeneralMaster(jObject.getString("RetailerName").toUpperCase(),
                            jObject.getString("RetailerName").toUpperCase()));
                }

               // distributerList.add(1, new
    ...
    public  void bindDistributorApi(String taluka)
    {
       try {
           if (config.NetworkConnection()) {
               new GetDistributorList("", this).execute();
           } else {
        ...
        if (fl) {
           /* if (config.NetworkConnection()) {
            ...
            else*/
            {
                ...
                Config.refreshActivity(DistributerVisitsActivityOnline.this);
                dialog.dismiss();
                relPRogress.setVisibility(View.GONE);
                container.setClickable(true);
                container.setEnabled(true);
...
//            progressDailog.show();
            ...
            try {
                ...
                if (jsonObject.has("success")) {
                    if (Boolean.parseBoolean(jsonObject.get("success").toString())) {
                        ...
                        androidx.appcompat.app.AlertDialog.Builder builder = new androidx.appcompat.app.AlertDialog.Builder(DistributerVisitsActivityOnline.this);
                        builder.setTitle("MyActivity");
    ...
    private class GetDistributorList extends AsyncTask<String, String, String> {

        private ProgressDialog progressDailog;

        public GetDistributorList(String Funname, Context context) {
        ...
        protected String doInBackground(String... urls)
        {
           String result="";
            ...
            try {
                jsonParam.put("userName", userCode);
                jsonObject.put("Table", jsonParam);
                Log.d("Village List ", jsonObject.toString());
                //Get the Response for the request
                result= HttpUtils.POSTJSON(Constants.getDistributorlistByUser_SERVER_API,jsonObject,mPref.getString(AppConstant.ACCESS_TOKEN_TAG,""));
            } catch (Exception e)
            {
                e.printStackTrace();
                result="";
            ...
            try {
                ...
                if (resultout.contains("True")) {
                    if (resultout.contains("True")) {
                        ...
                        bindDistributorOnline(resultout);
                    } else {
                        alertPoorConnection();
                    }
