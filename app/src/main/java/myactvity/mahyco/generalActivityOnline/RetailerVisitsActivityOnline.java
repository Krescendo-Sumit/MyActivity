package myactvity.mahyco.generalActivityOnline;
 ...
 */
public class RetailerVisitsActivityOnline extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks,
        GoogleApiClient.OnConnectionFailedListener, LocationListener, ResultCallback {
    Context context;

    private static final String TAG = "RetailerVisitsActivity";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_retailer_visits_online);
    ...
    private void initUI() {
        ...
        lblheader.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(RetailerVisitsActivityOnline.this, AndroidDatabaseManager.class);
                ...
                try {
                    ...
                    if (retailerList != null) {
                        if (position ==  1) {
                            ...
                            editor.commit();
                            intent = new Intent(RetailerVisitsActivityOnline.this, RetailerandDistributorTag.class);
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (validation()) {
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(RetailerVisitsActivityOnline.this);
...
//        }
        ...
        if (fl) {
           /* if (config.NetworkConnection())
           ...
           else*/
            {
                ...
                Config.refreshActivity(RetailerVisitsActivityOnline.this);
                // dialog.dismiss();
                relPRogress.setVisibility(View.GONE);
                container.setClickable(true);
                container.setEnabled(true);
            ...
            if (count > 0) {
                ...
                try {
                    ...
                    try {
                        ...
                        Log.d("rhtt", "uploadRetailerVisitsData: " + jsonObject);


                    } catch (JSONException e) {
                        e.printStackTrace();
                    }
                    str = new UploadRetailerVisitsData(functionName, jsonObject).execute(SERVER).get();
     ...
     */
    private class UploadRetailerVisitsData extends AsyncTask<String, String, String> {
        ...
        public UploadRetailerVisitsData(String Funname, JSONObject obj) {
            ...
            try {
                ...
                if (jsonObject.has("success")) {
                    if (Boolean.parseBoolean(jsonObject.get("success").toString())) {
                        ...
                        androidx.appcompat.app.AlertDialog.Builder builder = new androidx.appcompat.app.AlertDialog.Builder(RetailerVisitsActivityOnline.this);
                        builder.setTitle("MyActivity");
