...
public class retailerCompetitatorPOGupdateveg extends AppCompatActivity {
    ProgressDialog pd;
    ...
    String state,dist,taluka,mktplace,RetailerMobileno,RetailerType,compcode;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_retailer_competitator_pogupdateveg) ;
        ...
        spCropType.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                {
                    Toast.makeText(retailerCompetitatorPOGupdateveg.this,ex.toString(),Toast.LENGTH_LONG).show();
                }
                ...
                if (check > 1)
                {
                    ...
                    if(config.NetworkConnection()) {
                        new UpdatedPOG("6", objAsBytes, usercode, cropcode,
            ...
            public void onNothingSelected(AdapterView<?> arg0) {
                Toast.makeText(retailerCompetitatorPOGupdateveg.this, "gngvnv", Toast.LENGTH_LONG).show();
            }
        });
    ...
    public void UpdateRetailerPOG(String crop_Code)
    {
        try {
           ...
           /* String searchQuery = "SELECT * from RetailerCompetitatorPOGTable " +
            ...
            /*   mDatabase.deleterecord("delete from RetailerCompetitatorPOGTable" +
                    " where CropName='" + croptype + "' " +
                    "and  RetailerMobileno='"+RetailerMobileno+"' ");*/
            mDatabase.deleterecord("delete from RetailerCompetitatorPOGTable" +
                    " where CropCode='" + crop_Code + "' " +
            ...
            for (int i = 1; i < my_linear_layout1.getChildCount(); i++) {
                ...
                if(compname.length() !=0 && txtsoldtofarmer1.getText().length() !=0 &&
                    ...
                    boolean f = mDatabase.InsertRetailerCompetitatorPOGData(pref.getString("UserID", null),
            ...
            if (count > 0) {
                ...
                new SyncPOGData_Async("MDO_VegRetailerCompetitorPOGData","DistributorAsRetailer3").execute();
                ...
                msclass.showMessage("Please check the stock  details \n" +
                        "(company name,received stock,sold stock,balance stock should not empty)");
        ...
        try {
            ...
            try {
               ...
               /* String searchQuery = "SELECT distinct  CropName," +
                        ...
                        " from  RetailerCompetitatorPOGTable  " +
                        " where CropName='" + croptype + "'" +
                        " and RetailerMobileno='"+RetailerMobileno+"'  "; */
                ...
                //HEADER START
                final View view1 = LayoutInflater.from(this).inflate(R.layout.competitatorpoggridviewshowveg, null);
                ...
                for (int i = 0; i < 4; i++) {
                    ...
                    int total = 0;
                    final View view2 = LayoutInflater.from(this).inflate(R.layout.competitatorpoggridviewshowveg, null);
                                ...
                                if (listenForChanges)
                                {
                                    ...
                                    if (s.length() != 0) { //do your work here }
                                        ...
                                        if (lblreceived1.getText().length() != 0) {
                                            ...
                                            if (Double.valueOf(lblsoldtofarmer1.getText().toString())>Double.valueOf(lblreceived1.getText().toString()))
                                            {
                                                ...
                                                double cont = Double.valueOf(lblreceived1.getText().toString()) - Double.valueOf(lblsoldtofarmer1.getText().toString());
        ...
        protected void onPostExecute(String result) {
            try {
                ...
                if (result.contains("True"))
                {
                    ...
                    Toast.makeText(context, "Retailer POG data updated successfully.",
    ...
    public String  MDO_POGData()
    {
        ...
        if (count > 0) {
            try {
                ...
                returnvalue= syncPOGdata("MDO_VegRetailerCompetitorPOGData", objAsBytes, Imagestring1, Imagestring2, ImageName, "",cx.MDOurlpath);
