...
public class CardviewOrderHistoryChildAdapter extends RecyclerView.Adapter<CardviewOrderHistoryChildAdapter.ItemViewHolder> {

    List<PaymentHistoryOrderDetailModel> itemList;
    Context context;
    public CardviewOrderHistoryChildAdapter(Context context, List<PaymentHistoryOrderDetailModel> itemList) {
