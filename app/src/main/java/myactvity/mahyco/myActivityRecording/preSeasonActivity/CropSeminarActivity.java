...
public class CropSeminarActivity extends AppCompatActivity implements
    ...
    MultiSelectionSpinner spProductName, spSelectRBM, spSelectTBM, spSelectMDO, spCropType;
    Button btnRetailerListPhoto, btnSubmit, btnActivityPhoto, btnFarmerListPhoto, btnAddDialog, btnTakePhoto;
    public Messageclass msclass;
    public SqliteDatabase mDatabase;
    EditText etFarmerName, etMobileNumber, etWhatsappNumber, etArea, etSeedQty, etDate, etRemarks, etCheckHybrid, etEventVenue;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_crop_seminar);
        ...
        dialog.setContentView(R.layout.activity_participant_list_crop_seminar);
...
*/
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (validation()) {
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(CropSeminarActivity.this);
    ...
    public boolean validationFarmerDetail() {
        ...
        //for input edit text
        if (etEventVenue.getText().length() == 0) {
            msclass.showMessage("Please enter event venue");
            return false;
        }
    ...
    public boolean validation() {
        ...
        {
            msclass.showMessage("Please select RBM/TBM/MDO attending the event .");

            return false;
        }
        //for images validations
        if (ivImage.getDrawable() == null) {
            msclass.showMessage("Please click activity image");
            return false;
        }
        if (ivImageFarmerListPhoto.getDrawable() == null) {
            msclass.showMessage("Please click farmer list image");
            return false;
        }
//        if (ivImageRetailerListPhoto.getDrawable() == null) {
...
//                        "SELECT MDO / SO"));
    ...
    private void onSelectFromGalleryResult(Intent data) {
        ...
        if (imageselect == 1) {
            ...
            ivImageFarmerListPhoto.setImageBitmap(bm);
        } else if (imageselect == 3) {
            ivImageRetailerListPhoto.setImageBitmap(bm);
        }
        ...
        try {
            ...
            if (imageselect == 1) {
                try {
                    ...
                    AppConstant.Imagename = "CropSeminarPhoto" + pref.getString("UserID", null) + String.valueOf(entrydate.getTime());
                ...
                try {
                    AppConstant.queryImageUrl = photoFile.getAbsolutePath();
                    AppConstant.imageUri = Uri.fromFile(new File(AppConstant.queryImageUrl));
                    AppConstant.Imagename2 = "CropSeminarFarmerListPhoto" + pref.getString("UserID", null) + String.valueOf(entrydate.getTime());
                    FileUtilImage.compressImageFile(AppConstant.queryImageUrl, AppConstant.imageUri,
                ...
                try {
                    AppConstant.queryImageUrl = photoFile.getAbsolutePath();
                    AppConstant.imageUri = Uri.fromFile(new File(AppConstant.queryImageUrl));
                    AppConstant.Imagename3 = "CropSeminarRetailerListPhoto" + pref.getString("UserID", null) + String.valueOf(entrydate.getTime());
                    FileUtilImage.compressImageFile(AppConstant.queryImageUrl, AppConstant.imageUri,
        ...
        try {
            ...
            btnAddDialog.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    CropSeminarModel cropSeminarModel = new CropSeminarModel();

                    if (spVillage.getSelectedItemPosition() != 0 ) {

                        if(etFarmerNo.getText().toString().length() != 0) {

                            if (farmerListCropSeminar != null) {
                                if (farmerListCropSeminar.size() > 0) {
                                    for (int i = 0; i < farmerListCropSeminar.size(); i++) {
                                        if (!farmerListCropSeminar.get(i).getVillageName().contains(spVillage.getSelectedItem().toString())) {
                                            cropSeminarModel.setVillageName(spVillage.getSelectedItem().toString());
                                            cropSeminarModel.setFarmerCount(etFarmerNo.getText().toString());
                                           // cropSeminarModel.setUniqueID(spVillage.getSelectedItem().toString() + timeStamp);
                                            cropSeminarModel.setUniqueID(config.getvalue(spVillage)+"_" + timeStamp);

                                            cropSeminarModel.setVillageType(villageType);
                                        } else {
                                    ...
                                    farmerListCropSeminar.add(cropSeminarModel);
                                    txtFarmerCount.setText(String.valueOf(farmerCount));
                                    txtVillageCount.setText(String.valueOf(farmerListCropSeminar.size()));
                                    etFarmerNo.setText("");
...
//            });
    ...
    public void createAndAddData() {
        ...
        try {
            ArrayList<CropSeminarModel> finalVillageList = new ArrayList<>();
            for (int i = 0; i < farmerListCropSeminar.size(); i++) {
                    finalVillageList.add(farmerListCropSeminar.get(i));
            }
            recDemoList.setLayoutManager(new LinearLayoutManager(context));
            recDemoList.setAdapter(new AddFarmerListCropSeminarAdapter(context, finalVillageList));
//            if (villageType.contains("other")) {
//                ArrayList<CropSeminarModel> otherVillageList = new ArrayList<>();
//                for (int i = 0; i < farmerListCropSeminar.size(); i++) {
//                    if (farmerListCropSeminar.get(i).getVillageType().contains("other")) {
//                        otherVillageList.add(farmerListCropSeminar.get(i));
//                    }
//                }
//                recDemoList.setLayoutManager(new LinearLayoutManager(context));
//                recDemoList.setAdapter(new AddFarmerListCropSeminarAdapter(context, otherVillageList));
//
//            } else if (villageType.contains("focussed")) {
//                ArrayList<CropSeminarModel> focussedList = new ArrayList<>();
//
//                for (int i = 0; i < farmerListCropSeminar.size(); i++) {
//                    if (farmerListCropSeminar.get(i).getVillageType().contains("focussed")) {
//                        focussedList.add(farmerListCropSeminar.get(i));
//                    }
//                }
//                recDemoList.setLayoutManager(new LinearLayoutManager(context));
//                recDemoList.setAdapter(new AddFarmerListCropSeminarAdapter(context, focussedList));
//            } else {
//                recDemoList.setLayoutManager(new LinearLayoutManager(context));
//                recDemoList.setAdapter(new AddFarmerListCropSeminarAdapter(context, farmerListCropSeminar));
//            }
    ...
    public void saveToDb() {
        ...
        JsonArray myCustomArray = gson.toJsonTree(farmerListCropSeminar).getAsJsonArray();
        finalVillageJSON = myCustomArray.toString();

        if (villageJSONValidation()) {
            ...
            Date entrydate = new Date();
            final String activityImgPath, farmerListPhotoPath, retailerListPhotoPath;
            activityImgPath = Imagepath1;
            farmerListPhotoPath = Imagepath2;
            retailerListPhotoPath = Imagepath3;
            final String activityImgName = AppConstant.Imagename ;// "CropSeminarPhoto" + pref.getString("UserID", null) + String.valueOf(entrydate.getTime());
            final String farmerListPhotoName = AppConstant.Imagename2;// "CropSeminarFarmerListPhoto" + pref.getString("UserID", null) + String.valueOf(entrydate.getTime());
            final String retailerListPhotoName = AppConstant.Imagename3 ;//"CropSeminarRetailerListPhoto" + pref.getString("UserID", null) + String.valueOf(entrydate.getTime());

            boolean fl = mDatabase.insertCropSeminarData(userCode, state, district, taluka, eventVenue,
                    cropType, product, taggedCordinates + " " + taggedAddress, taggedCordinates, finalVillageJSON, selectRBM, selectTBM, selectMDO, retailerCount, activityImgName, activityImgPath,
                    activityImgStatus, farmerListPhotoName, farmerListPhotoPath, farmerListPhotoStatus, retailerListPhotoName, retailerListPhotoPath,
                    retailerListPhotoStatus, isSynced);


            if (fl) {

                if (CommonUtil.addGTVActivity(context, "4", "Crop seminar", cordinates, eventVenue+" "+product,"GTV")) {
                    // Toast.makeText(context, "Good Going", Toast.LENGTH_SHORT).show();
                }
                //msclass.showMessage("data saved successfully.");
                uploadData("CropSeminarData");
                relPRogress.setVisibility(View.GONE);
                container.setClickable(true);
                container.setEnabled(true);
                getWindow().clearFlags(WindowManager.LayoutParams.FLAG_NOT_TOUCHABLE);
    ...
    /**
     * <P>Method is used to validate the Village details json</P>
     * @return
     */
    private Boolean villageJSONValidation() {

        try {
            JSONArray object = new JSONArray(finalVillageJSON);
            if (object.length() == 0) {
    ...
    public void uploadData(String CropSeminarData) {
        String str = null;
       /* if (config.NetworkConnection()) {

            try {
                new UploadCropSeminarDataServer(CropSeminarData, context).execute(SERVER).get();
        ...
        if (count > 0) {
            try {
                ...
                for (int i = 0; i < jsonArray.length(); i++) {
                    ...
                    str = syncCropSeminarDataSingleImage(CropSeminarData, SERVER, jsonObject, activityImgName, activityImgPath, farmerListPhotoName, farmerListPhoto, retailerListPhotoName, retailerListPhoto);
...
//            progressDailog.show();
                ...
                if (jsonObject.has("success")) {
                    if (Boolean.parseBoolean(jsonObject.get("success").toString())) {
                       ...
                       // msclass.showMessage("Data Uploaded Successfully");
                        ...
                        androidx.appcompat.app.AlertDialog.Builder builder = new androidx.appcompat.app.AlertDialog.Builder(CropSeminarActivity.this);
                        builder.setTitle("MyActivity");
    ...
    public synchronized String syncCropSeminarDataSingleImage(String function, String urls, JSONObject jsonObject, String activityImgName,
                                                              String activityImgPath, String farmerListPhotoName, String farmerListPhoto,
                                                              String retailerListPhotoName, String retailerListPhoto) {
     ...
     /*   String encodedactivityImage = mDatabase.getImageDatadetail(activityImgPath);
        ...
        postParameters.add(new BasicNameValuePair("CropSeminarData", jsonObject.toString()));
