...
import myactvity.mahyco.DemoModelRecordActivity;
 ...
 */
public class FieldBannerActivity extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks,
        GoogleApiClient.OnConnectionFailedListener, LocationListener, ResultCallback,
        IPickResult,View.OnClickListener
{
    Context context;

    private static final String TAG = "FIELDBANNER";
    ...
    EditText etBannerCount, etRemarks;
    String userCode, state, taluka, dist, village, farmerDetails;
    Button btnSubmit, btnFieldBannerPhoto;
    ImageView imgBtnGps;
    ...
    private static final String IMAGE_DIRECTORY_NAME = "FIELDBANNER";
    File photoFile = null;
  ...
  //  String SERVER = "https://cmr.mahyco.com/MDOHandler.ashx";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_field_banner);
//        getSupportActionBar().hide(); //<< this
    ...
    private void initUI() {
        ...
        etBannerCount = (EditText) findViewById(R.id.etBannerCount);
        etRemarks = (EditText) findViewById(R.id.etRemarks);
        btnSubmit = (Button) findViewById(R.id.btnSubmit);
        lblheader = (TextView) findViewById(R.id.lblheader);
        tvCordinates = (TextView) findViewById(R.id.tvCordinates);
        tvAddress = (TextView) findViewById(R.id.tvAddress);
        btnFieldBannerPhoto = (Button) findViewById(R.id.btnFieldBannerPhoto);
        ...
        llOtherVillages.setVisibility(View.GONE); // Mahendra m
       // userCode = mPref.getString(AppConstant.USER_CODE_TAG, "");
        ...
        btnFieldBannerPhoto.setOnClickListener(this);
       /* btnFieldBannerPhoto.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //call the function to select image from album
                if (ContextCompat.checkSelfPermission(context, android.Manifest.permission.CAMERA)
                        == PackageManager.PERMISSION_DENIED) {
                    ActivityCompat.requestPermissions(FieldBannerActivity.this, new String[]{android.Manifest.permission.CAMERA}, 101);
                }
                imageselect = 1;
                // selectImage();
                try {
  ...
  */
        ...
        lblheader.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(FieldBannerActivity.this, AndroidDatabaseManager.class);
        ...
        spFocusedVillages.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                GeneralMaster gm = (GeneralMaster) parent.getSelectedItem();
                try {
                    focusedVillage = gm.Desc().trim();// URLEncoder.encode(gm.Code().trim(), "UTF-8");
                } catch (Exception e) {
                    e.printStackTrace();
                }
        ...
        spFarmerDetails.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                try {
                    ...
                    if (farmerlist != null) {
                        if (position ==  1) {
                            editor.putString("calldemoplot","FieldBanner");
                            editor.commit();
                            intent = new Intent(FieldBannerActivity.this, DemoModelRecordActivity.class);
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (validation()) {
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(FieldBannerActivity.this);
    ...
    public boolean validation() {
        ...
        if (etBannerCount.getText().toString().length() == 0) {
            Utility.showAlertDialog("Info", "Please Enter  No of Banner", context);
            return false;
        }
        ...
        if (ivImage.getDrawable() == null) {
          //  msclass.showMessage("Please click activity photo");
            msclass.showMessage("Please click field banner");
            return false;
        }
...
//                    "OTHER"));
    ...
    private boolean isAlreadydone(String retailerNumber) {
        ...
        Cursor data = mDatabase.fetchAlreadyExistsFieldBannerData(retailerNumber,spProductName.getSelectedItem().toString().trim() );
        if (data.getCount() == 0) {
            isExist = true;
        }
        data.close();
    ...
    public void saveToDb() {
        ...
        String bannerCount = etBannerCount.getText().toString();
        ...
        String isSynced = "0";
        String fieldBannerImgStatus = "0";


        Date entrydate = new Date();
        final String fieldBannerImgPath;
        fieldBannerImgPath = Imagepath1;
        final String fieldBannerImgName =AppConstant.Imagename;// "FieldBannerPhoto" + pref.getString("UserID", null) + String.valueOf(entrydate.getTime());


        boolean fl = mDatabase.insertFieldBannerData(userCode, focussedVillage, state, district, taluka, othervillage, bannerCount,remarks,
                farmerDetails, pkFarmerMobileNumber, cropType, product, taggedCordinates +" "+ taggedAddress, taggedCordinates, fieldBannerImgName, fieldBannerImgPath,
       ...
       /* if (config.NetworkConnection()) {
        ...
        } else */
        {
            ...
            builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    Config.refreshActivity(FieldBannerActivity.this);
                    dialog.dismiss();
                    relPRogress.setVisibility(View.GONE);
                    container.setClickable(true);
                    container.setEnabled(true);
    ...
    public String uploadFieldDayData(String function) {
        String str = "";
        int action = 1;
        ...
        if (count > 0) {
            try {
                ...
                for (int i = 0; i < jsonArray.length(); i++) {
                    ...
                    str = syncFieldDayDataSingleImage(function, SERVER, jsonObject, fieldBannerImgName,fieldBannerImgPath);

                    handleFieldDayDataImageSyncResponse("FieldBannerData", str,id);
                }
...
//            progressDailog.show();
        ...
        protected String doInBackground(String... urls) {
            ...
            return uploadFieldDayData("MDO_FieldBannerData");
                ...
                if(jsonObject.has("success"))
                {
                    if(Boolean.parseBoolean(jsonObject.get("success").toString())){
                       ...
                       // msclass.showMessage("Data Uploaded Successfully");
                        ...
                        androidx.appcompat.app.AlertDialog.Builder builder = new androidx.appcompat.app.AlertDialog.Builder(FieldBannerActivity.this);
                        builder.setTitle("MyActivity");
    ...
    public synchronized String syncFieldDayDataSingleImage(String function, String
      ...
      /*  String encodedFieldBannerImage = mDatabase.getImageDatadetail(fieldBannerImgPath);
        ...
        postParameters.add(new BasicNameValuePair("FieldBannerData", jsonObject.toString()));
        postParameters.add(new BasicNameValuePair("encodedFieldBannerImage", encodedFieldBannerImage));

        String Urlpath = urls + "?fieldBannerImgName=" + fieldBannerImgName;
