...
public class FieldBoardActivity extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks,
    ...
    private static final String TAG = "FIELDBOARD";
    ...
    EditText etBoardCount, etRemarks;
    String userCode, state, taluka, dist, village, farmerDetails;
    Button btnSubmit, btnFieldBoardPhoto;
    ImageView imgBtnGps;
  ...
  //  String SERVER = "https://cmr.mahyco.com/MDOHandler.ashx";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_field_board);
//        getSupportActionBar().hide(); //<< this
    ...
    private void initUI() {
        ...
        etBoardCount = (EditText) findViewById(R.id.etBoardCount);
        etRemarks = (EditText) findViewById(R.id.etRemarks);
        btnSubmit = (Button) findViewById(R.id.btnSubmit);
        lblheader = (TextView) findViewById(R.id.lblheader);
        tvCordinates = (TextView) findViewById(R.id.tvCordinates);
        tvAddress = (TextView) findViewById(R.id.tvAddress);
        btnFieldBoardPhoto = (Button) findViewById(R.id.btnFieldBoardPhoto);
        ...
        btnFieldBoardPhoto.setOnClickListener(this);
        /*btnFieldBoardPhoto.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //call the function to select image from album
                if (ContextCompat.checkSelfPermission(context, android.Manifest.permission.CAMERA)
                        == PackageManager.PERMISSION_DENIED) {
                    ActivityCompat.requestPermissions(FieldBoardActivity.this, new String[]{android.Manifest.permission.CAMERA}, 101);
                }
                imageselect = 1;
                // selectImage();
                try {
...
*/
        ...
        lblheader.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(FieldBoardActivity.this, AndroidDatabaseManager.class);
                ...
                try {
                    ...
                    if (farmerlist != null) {
                        if (position == 1) {
                            ...
                            editor.putString("calldemoplot","FieldBoard");
                            editor.commit();
                            intent = new Intent(FieldBoardActivity.this, DemoModelRecordActivity.class);
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (validation()) {
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(FieldBoardActivity.this);
    ...
    public boolean validation() {
        ...
        if (etBoardCount.getText().toString().length() == 0) {
            Utility.showAlertDialog("Info", "Please Enter  No of Board", context);
            return false;
        }
        ...
        if (ivImage.getDrawable() == null) {
            msclass.showMessage("Please click field board photo");
            return false;
        }
...
//
    ...
    private boolean isAlreadydone(String retailerNumber) {
        ...
        Cursor data = mDatabase.fetchAlreadyExistsFieldBoardData(retailerNumber,spProductName.getSelectedItem().toString().trim() );
        if (data.getCount() == 0) {
            isExist = true;
        }
        data.close();
    ...
    public void saveToDb() {
        ...
        String boardCount = etBoardCount.getText().toString();
        ...
        String isSynced = "0";
        String fieldBoardImgStatus = "0";
        Date entrydate = new Date();
        final String fieldBoardImgPath;
        fieldBoardImgPath = Imagepath1;
        final String fieldBoardImgName =AppConstant.Imagename;// "FieldBoardPhoto" + pref.getString("UserID", null) + String.valueOf(entrydate.getTime());

        boolean fl = mDatabase.insertFieldBoardData(userCode, focussedVillage, state, district, taluka, othervillage, boardCount,remarks,
                farmerDetails, pkFarmerMobileNumber, cropType, product, taggedCordinates +" "+ taggedAddress, taggedCordinates, fieldBoardImgName, fieldBoardImgPath,
        ...
        public void uploadData (String FieldDayData){
           ...
           /* if (config.NetworkConnection()) {
                ...
                builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Config.refreshActivity(FieldBoardActivity.this);
                        dialog.dismiss();
                        relPRogress.setVisibility(View.GONE);
                        container.setClickable(true);
                        container.setEnabled(true);
            ...
            if (count > 0) {
                try {
                    ...
                    for (int i = 0; i < jsonArray.length(); i++) {
                        ...
                        str = syncFieldDayDataSingleImage(function, SERVER, jsonObject,  fieldBoardImgPathName, fieldBoardImgPath);
                        handleFieldDayDataImageSyncResponse("MDO_FieldBoardData", str,id);
                    }
...
//            progressDailog.show();
            ...
            protected String doInBackground(String... urls) {
                ...
                return uploadFieldDayData("MDO_FieldBoardData");
                    ...
                    if(jsonObject.has("success"))
                    {
                        if(Boolean.parseBoolean(jsonObject.get("success").toString())){
                           ...
                           // msclass.showMessage("Data Uploaded Successfully");
                            ...
                            androidx.appcompat.app.AlertDialog.Builder builder = new androidx.appcompat.app.AlertDialog.Builder(FieldBoardActivity.this);
                            builder.setTitle("MyActivity");
        ...
        urls, JSONObject jsonObject, String fieldBoardImgPathName,
         ...
         /*   String encodedactivityImage = mDatabase.getImageDatadetail(fieldBoardImgPath);
            ...
            postParameters.add(new BasicNameValuePair("FieldBoardData", jsonObject.toString()));
            postParameters.add(new BasicNameValuePair("encodedFieldBoardImage", encodedactivityImage));

            String Urlpath = urls + "?fieldBoardImgName=" + fieldBoardImgPathName;
