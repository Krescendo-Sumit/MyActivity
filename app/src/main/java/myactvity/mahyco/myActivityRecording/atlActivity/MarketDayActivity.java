 ...
 */
public class MarketDayActivity extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks,
        GoogleApiClient.OnConnectionFailedListener, LocationListener, ResultCallback,
        IPickResult,View.OnClickListener{
    Context context;

    private static final String TAG = "MARKETDAYACTIVITIES";
    ...
    private static final String IMAGE_DIRECTORY_NAME = "MARKETDAYACTIVITIES";
    File photoFile = null;
        ...
        btnActivityPhoto.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (ContextCompat.checkSelfPermission(context, android.Manifest.permission.CAMERA)
                    ...
                    ActivityCompat.requestPermissions(MarketDayActivity.this, new String[]{android.Manifest.permission.CAMERA}, 101);
                }
                imageselect = 1;
                try {
 ...
 */
        ...
        lblheader.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MarketDayActivity.this, AndroidDatabaseManager.class);
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (validation()) {
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(MarketDayActivity.this);
    ...
    public boolean validation() {
        ...
        if (editTextNoOfVisitors.getText().toString().length() == 0) {
...
//                    "OTHER"));
   ...
   /* @Override
    ...
    public void saveToDb() {
        ...
        final String activityImgName =AppConstant.Imagename ;// "ATLMarketDayPhoto" + pref.getString("UserID", null) + String.valueOf(entrydate.getTime());

        boolean fl = mDatabase.insertATLMarketDayData(userCode, focussedVillage, state, district, taluka, othervillage,
                numberOfVisitors, taggedCordinates +" "+ taggedAddress, taggedCordinates, activityImgName,
    ...
    public void uploadData(String atlMarketDayData) {
        String str = null;
        /*if (config.NetworkConnection()) {

            try {
                new UploadATLMarketDayDataServer(atlMarketDayData, context).execute(SERVER).get();
            ...
            builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    Config.refreshActivity(MarketDayActivity.this);
                    dialog.dismiss();
                    relPRogress.setVisibility(View.GONE);
                    container.setClickable(true);
                    container.setEnabled(true);
        ...
        if (count > 0) {
            ...
            try {
                ...
                for (int i = 0; i < jsonArray.length(); i++) {
                    ...
                    str = syncATLMarketDayDataSingleImage(atlMarketDayData, SERVER, jsonObject, activityImgName, activityImgPath);
                ...
                if(jsonObject.has("success"))
                {
                    if(Boolean.parseBoolean(jsonObject.get("success").toString())){
                       ...
                       // msclass.showMessage("Data Uploaded Successfully");
                        ...
                        androidx.appcompat.app.AlertDialog.Builder builder = new androidx.appcompat.app.AlertDialog.Builder(MarketDayActivity.this);
                        builder.setTitle("MyActivity");
    ...
    public void handleATLMarketDayDataImageSyncResponse(String function, String resultout,String id) throws JSONException {
        if (function.equals("ATLMarketDayData")) {
            JSONObject jsonObject = new JSONObject(resultout);
            if (jsonObject.has("success")) {
                if (Boolean.parseBoolean(jsonObject.get("success").toString())) {
