...
public class distributorCompetitatorPOGupdate extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_distributor_competitator_pogupdate) ;
        ...
        spCropType.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                {
                    Toast.makeText(distributorCompetitatorPOGupdate.this,ex.toString(),Toast.LENGTH_LONG).show();
                }
            ...
            public void onNothingSelected(AdapterView<?> arg0) {
                Toast.makeText(distributorCompetitatorPOGupdate.this, "gngvnv", Toast.LENGTH_LONG).show();
            }
        });
        ...
        try {
            ...
            try {
               ...
               /* String searchQuery = "SELECT distinct CropName," +
                ...
                //HEADER START
                final View view1 = LayoutInflater.from(this).inflate(R.layout.distributorcompetitatorpoggridviewshow, null);
                                ...
                                if (listenForChanges)
                                {
                                    ...
                                    if (s.length() != 0) { //do your work here }
                                        ...
                                        if (lblreceived1.getText().length() != 0) {
                                            ...
                                            if (Integer.valueOf(lblbal1.getText().toString())>Integer.valueOf(lblreceived1.getText().toString()))
                                            {
                                                ...
                                                int cont = Integer.valueOf(lblreceived1.getText().toString()) - Integer.valueOf(lblbal1.getText().toString());
