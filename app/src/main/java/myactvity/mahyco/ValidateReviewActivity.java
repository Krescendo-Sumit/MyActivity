...
public class ValidateReviewActivity extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks,
        GoogleApiClient.OnConnectionFailedListener, LocationListener,
        IPickResult,View.OnClickListener,ResultCallback {

    private static final String TAG = "VALIDATEREVIEWRECORD";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
       ...
       // setContentView(R.layout.activity_validate_review); mahendra
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (validation()) {
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(ValidateReviewActivity.this);
...
//
    ...
    public void getIntentData() {
        ...
        Log.d("datafromprevious", uid + "::" + mobilenumber + "::" + date + "|||" + mdoCode);
    }
    ...
    public boolean validation() {
       ...
       /* if (spPurpose.getSelectedItemPosition() == 0) {
            msclass.showMessage("Please Select Pupose of visit");
            return false;
        }*/
        if (spCropCondition .getSelectedItemPosition() == 0) {
            msclass.showMessage("Please Select crop condtion.");
            return false;
        }
        return true;
    }
    ...
    public void saveToDb() {
        ...
        final String imageName = AppConstant.Imagename;// "ValidateDemoReview" + pref.getString("UserID", null) + String.valueOf(entrydate.getTime());
        ...
        if (!isAlreadydone(uId)) {
            ...
            String searchQuery = "SELECT *  FROM ValidatedDemoModelData where uId='" + uid + "'";
            ...
            if (cursor != null && cursor.getCount() > 0) {
                ...
                boolean fl = mDatabase.insertReviewValidationData(uId, uid, userCode, taluka, farmerName,
                        mobilenumber, crop, product,
                        area, date, txtVisitingDate.getText().toString(), cordinates,
                        purposeVisit, comments, imageName, tempImagePath, imgStatus, isSynced,
                        mdoCode, date, "0",
                ...
                if (fl) {
                    ...
                    uploadValidatedReviewRecords("mdo_demoModelVisitDetail_validation");
            ...
            msclass.showMessage("Entry Already Done");
    ...
    private boolean isAlreadydone(String id) {
        ...
        Cursor data = mDatabase.fetchAlreadyExistsInValidateReview(id);
...
//        }
    ...
    private synchronized void startFusedLocationService() {
        ...
        try {
            ...
            if (IsGPSEnabled) {
                ...
                androidx.appcompat.app.AlertDialog.Builder builder = new androidx.appcompat.app.AlertDialog.Builder(ValidateReviewActivity.this);
    ...
    public void uploadValidatedReviewRecords(String uploadValidatedReviewData) {
        String str = null;
        if (config.NetworkConnection()) {
//            progressDailog.show();
            try {
                new UploadDataServer(uploadValidatedReviewData, context).execute(SERVER).get();
            ...
            builder.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    ...
                    Intent intent = new Intent(ValidateReviewActivity.this, ValidateReviewListActivity.class);
    ...
    public String uploadvalidateReview(String uploadValidatedReviewData) {
        String str = "";
...
//                        Log.d("ObjectasBytes", jsonObject.toString());
                        str = syncSingleImage(uploadValidatedReviewData, SERVER, action, objAsBytes, uId, imageName, imagePath);

                        handleImageSyncResponse(uploadValidatedReviewData, str, uId);
                    }
...
//            progressDailog.show();
        ...
        protected String doInBackground(String... urls) {
            ...
            return uploadvalidateReview("mdo_demoModelVisitDetail_validation");
...
//                        progressDailog.dismiss();
    ...
    public synchronized String syncSingleImage(String function, String urls, int action,
...
//            progressDailog.dismiss();
    ...
    public void handleImageSyncResponse(String function, String resultout, String id) {
        if (function.equals("mdo_demoModelVisitDetail_validation")) {
            if (resultout.contains("True")) {
