package myactvity.mahyco.postSeasonActivityOnline;
...
public class CropShowActivityOnline extends AppCompatActivity implements
    ...
    List<GeneralMaster>  vilageList, focussedVillageList;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_crop_show_online);
        ...
        spTaluka.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (radOnline.isChecked())
                {
                    ...
                    bindVillage(taluka);
                    bindFocussedVillage(spFocusedVillages);
                }
            }
        ...
        spTalukaRetailer.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                try {
                    ...
                    if (radOnline.isChecked())
                    {
                        bindRetailerApi(talukaRetailer);
                    }
                    else {
                ...
                try {
                    ...
                    if (farmerlist != null) {
                        if (position == 1) {
                            ...
                            intent = new Intent(CropShowActivityOnline.this, DemoModelRecordActivity.class);
        ...
        spRetailerDetails.setListener(new MultiSelectionSpinner.MySpinnerListener() {
            ...
            public void selectedStrings(List<String> strings) {
                ...
                if(String.valueOf(strings).contains("OTHER")) {
                    ...
                    Intent intent;
                    intent = new Intent(CropShowActivityOnline.this, RetailerandDistributorTag.class);
                    intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                    startActivity(intent);
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (validation()) {
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(CropShowActivityOnline.this);
...
//                        "OTHER"));
        ...
        try {
            ...
            if (imageselect == 3) {
                ...
                try {
                    ...
                    Bitmap myBitmap = BitmapFactory.decodeFile(photoFile3.getAbsolutePath(), options);
                    Imagepath3 = photoFile3.getAbsolutePath();
    ...
    public void saveToDb() {
        ...
        final String activityImgName = "CropShowPhoto" + pref.getString("UserID", null) + String.valueOf(entrydate.getTime());
        final String farmerListPhotoName = "CropShowFarmerListPhoto" + pref.getString("UserID", null) + String.valueOf(entrydate.getTime());
        final String retailerListPhotoName = "CropShowRetailerListPhoto" + pref.getString("UserID", null) + String.valueOf(entrydate.getTime());
        ...
        boolean fl = mDatabase.insertCropShowData(userCode, focussedVillage, state, district, taluka, othervillage,
                farmerDetails, retailerDetails, pkRetailerMobileNumber, talukaMDO,
                cropType, product, taggedCordinates +" "+ taggedAddress, taggedCordinates, finalVillageJSON, activityImgName, activityImgPath,
                activityImgStatus, farmerListPhotoName, farmerListPhoto,
                farmerListPhotoStatus, retailerListPhotoName,
                retailerListPhoto, retailerListPhotoStatus, isSynced,villagecode);
    ...
    public void uploadData(String CropShowData) {
       ...
       /* if (config.NetworkConnection()) {
            ...
            builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    Config.refreshActivity(CropShowActivityOnline.this);
                    dialog.dismiss();
                    relPRogress.setVisibility(View.GONE);
                    container.setClickable(true);
                    container.setEnabled(true);
...
//
    ...
    public  void bindRetailerApi(String taluka)
    {
        if (config.NetworkConnection()) {
            new GetRetailerList("", this).execute();
        }
        else
        {
            msclass.showMessage("Internet connection not available");
    ...
    public void bindRetailerOnline(String result ) {
        String[] array;
        try {
            JSONObject jsonObject = new JSONObject(result);
            JSONArray jArray = jsonObject.getJSONArray("Table");//new JSONArray(result);
            array = new String[jArray.length() + 2];
            array[0] = "SELECT RETAILER";
            for (int i = 0; i < jArray.length(); i++) {
                JSONObject jObject = jArray.getJSONObject(i);
                array[i + 1] = jObject.getString("firmname").toUpperCase();
            }
            array[jArray.length()+1]= "OTHER";
            if (array.length > 0) {
                spRetailerDetails.setItems(array);
    ...
    public void bindFocussedVillage(SearchableSpinner spVillage) {
        ...
        try {
            ...
            searchQuery = "SELECT distinct vil_desc,vil_code " +
                    " FROM FocussedVillageMaster where upper(taluka)='"+taluka.toUpperCase()+"'" +
                    " order by vil_desc asc  ";
...
//                recDemoList.setAdapter(new AddFarmerListCropShowAdapter(context, farmerListCropShow));
    ...
    private class GetVillageList extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            progressDailog.setMessage("Waiting ");
            progressDailog.show();
        }
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                if (resultout.contains("True")) {
                    ...
                    androidx.appcompat.app.AlertDialog.Builder builder = new androidx.appcompat.app.AlertDialog.Builder(CropShowActivityOnline.this);
                    builder.setTitle("Info");
                    builder.setMessage("Something went wrong please try again later.");
                    builder.setCancelable(false);
                    builder.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
    ...
    // Get Online Retailer List
    private class GetRetailerList extends AsyncTask<String, String, String> {

        private ProgressDialog progressDailog;

        public GetRetailerList(String Funname, Context context) {
        ...
        protected String doInBackground(String... urls)
        {
            ...
            JSONObject jsonParam = new JSONObject();
            try {
                jsonParam.put("taluka", talukaRetailer);
                jsonObject.put("Table", jsonParam);
                Log.d("Village List ", jsonObject.toString());
                //Get the Response for the request
                return HttpUtils.POSTJSON(Constants.getRetailerListByTaluka_SERVER_API,jsonObject,mPref.getString(AppConstant.ACCESS_TOKEN_TAG,""));
