 ...
 */
public class LivePlantDisplayRetailCounterActivityOnline extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks,
    ...
    String SERVER = "https://maapackhousenxg.mahyco.com/api/postSeason/livePlantDisplayRetailerData";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_live_plant_display_retail_counter_online);
       ...
       // bindRetailer("");
        ...
        lblheader.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(LivePlantDisplayRetailCounterActivityOnline.this, AndroidDatabaseManager.class);
                ...
                try {
                    ...
                    if (retailerList != null) {
                        if (position == 1) {
                            ...
                            editor.commit();
                            intent = new Intent(LivePlantDisplayRetailCounterActivityOnline.this, RetailerandDistributorTag.class);
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (validation()) {
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(LivePlantDisplayRetailCounterActivityOnline.this);
...
//            }
    ...
    public void bindRetailerOnline(String result ) {
        ...
        try {
            ...
            try {
                ...
                for (int i = 0; i < jArray.length(); i++) {
                    JSONObject jObject = jArray.getJSONObject(i);
                    retailerList.add(new GeneralMaster(jObject.getString("firmname").toUpperCase(),
                            jObject.getString("firmname").toUpperCase()));
                }
    ...
    public void saveToDb() {
        ...
        final String activityImgName = "LivePlantDisplayRetailerPhoto" + pref.getString("UserID", null) + String.valueOf(entrydate.getTime());
    ...
    public void uploadLivePlantDisplayRetailerData(String LivePlantDisplayRetailerData) {
        ...
        /*if (config.NetworkConnection()) {
            ...
            builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    Config.refreshActivity(LivePlantDisplayRetailCounterActivityOnline.this);
                    dialog.dismiss();
                    relPRogress.setVisibility(View.GONE);
                    container.setClickable(true);
                    container.setEnabled(true);
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                if (resultout.contains("True")) {
                    ...
                    androidx.appcompat.app.AlertDialog.Builder builder = new androidx.appcompat.app.AlertDialog.Builder(LivePlantDisplayRetailCounterActivityOnline.this);
                    builder.setTitle("Info");
                    builder.setMessage("Something went wrong please try again later.");
                    builder.setCancelable(false);
                    builder.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
