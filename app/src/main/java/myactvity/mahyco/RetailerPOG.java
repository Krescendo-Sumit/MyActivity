...
public class RetailerPOG extends AppCompatActivity  implements GoogleApiClient.ConnectionCallbacks,
    ...
    public SearchableSpinner2 spTaluka,spRetailerName,spRetailerCategory;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_retailer_pog);
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                try {
                   ...
                   /* JSONObject object = new JSONObject();
                    ...
                    if (spRetailerName.getSelectedItem().toString().toLowerCase().contains("retailer not found") )
                    {
                        AlertDialog.Builder alertDialog = new AlertDialog.Builder(RetailerPOG.this);
        ...
        btnPOG.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try
                {
                    ...
                    if (validation()==true) {
                        Intent intent = new Intent(context.getApplicationContext(), retailerpogupdateDetail.class);
                        intent.putExtras(bundle);
            ...
            public void onClick(View v) {
                try
                {
                    ...
                    if (validation()==true) {
                        ...
                        Intent intent = new Intent(context.getApplicationContext(), retailerCompetitatorPOGupdate.class);
                ...
                try {
                    ...
                    if (config.NetworkConnection()) {
                        try {
                            ...
                            if(spRetailerCategory.getSelectedItem().toString().toUpperCase().contains("OTHER")) {
                                Croplist.add(new GeneralMaster("RETAILER NOT FOUND",
                                        "RETAILER NOT FOUND"));
                            }
                        } catch (JSONException e) {
    ...
    private synchronized void startFusedLocationService() {
        try {
            ...
            if (IsGPSEnabled) {
                ...
                androidx.appcompat.app.AlertDialog.Builder builder = new androidx.appcompat.app.AlertDialog.Builder(RetailerPOG .this);
