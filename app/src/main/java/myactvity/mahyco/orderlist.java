...
public class orderlist extends AppCompatActivity {
    ...
    public void onBackPressed() {
        ...
        Intent intent = new Intent(context.getApplicationContext(), saleorderpending.class);
    ...
    public void bindorderlist(String str)
    {
        try {
            ...
            if(jArray.length()==0 )
            {
                ...
                lblList.setText("pendig order list not found");
    ...
    private void bindproductlist(String str,LinearLayout my_linear_layout1)
    {
        ...
        try {
            ...
            for(int i=0; i <jArray.length(); i++) {
                ...
                View view2 = LayoutInflater.from(this).inflate(R.layout.ordersave, null);
                ...
                txtproducthide.setText(jObject.getString("MATNR")+"|"+
                        ...
                        +jObject.getString("MTART")+"|"+jObject.getString("MATKL"));
                                ...
                                final String customergroup)
    {
        try {
            ...
            dialog.setContentView(R.layout.addorderpanel);
                ...
                public void onClick(View v) {
                    try
                    {
                        ...
                        for (int i = 0; i < my_linear_layout1.getChildCount(); i++) {
                            ...
                            if(txtqtypkt.getText().length()==0)// || Integer.valueOf(txtqtypkt.getText().toString())==0 )
                            {
                            ...
                            String QTYPKT=txtqtypkt.getText().toString();
                            //String PKTSIZE="0";
                            if(txtqtypkt.getText().length()!=0) {
                        ...
                        // SUBMIT ORDER BY RBM
                        if (count==0) {
                            new Saleordersumbit(orderid, "6", objAsBytes, usercode, sales_org, division, customer, "",
                                    DLV_plant, customergroup, my_linear_layout1).execute();
                            //msclass.showMessage("OK");
                        }
                        else
                        {
                            if (count>0) {
            ...
            String str=  new Saleorderdata(orderid,"5",objAsBytes,orderid,"","","","","","").execute().get();
    ...
    private void prepareListData() {
        ...
        if (config.NetworkConnection()) {
            ...
            byte[] objAsBytes = new byte[1];
            new Saleorderdata(TBMcode,"3",objAsBytes,usercode,"","","","","","").execute();
        }
        else
        {
    ...
    public class Saleorderdata extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... urls) {
            ...
            String Urlpath1= SERVERsaleorder+"?orderid="+orderid+"&action="+action+"&usercode="+usercode+"&saleorg="+saleorg+"" +
            ...
            try{
                ...
                if (result.contains("True")) {
                    ...
                    if(action.equals("6")) // Order Submit
                    {
                        ...
                        logSalesApproved(context);

                    }
                    if(action.equals("3")) // Pending Order list
                    {
    ...
    public class Saleordersumbit extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... urls) {
            ...
            StringBuilder builder = new StringBuilder();
            List<NameValuePair> postParameters = new ArrayList<NameValuePair>(2);
            postParameters.add(new BasicNameValuePair("Type", "SubmitToCreateSO"));
            postParameters.add(new BasicNameValuePair("encodedData",encodeImage));
            String Urlpath1= SERVERsaleorder+"?orderid="+orderid+"&action="+action+"&usercode="+usercode+"&saleorg="+saleorg+"" +
                    "&division="+division+"&customer="+customer+"" +
    ...
    */
    ...
    private void logSalesApproved(Context context){
        if(pref!=null){
            String userId="", displayName="";
            if (pref.getString("UserID", null) != null && pref.getString("Displayname", null) != null ){
                userId = pref.getString("UserID", "");
                displayName = pref.getString("Displayname", "");
                FirebaseAnalyticsHelper.getInstance(context).callSaleOrderApprovedOrder(userId,displayName);
            }
        }
    }
}