 ...
 */
public class DemoPlotReviewListAdapter extends RecyclerView.Adapter<DemoPlotReviewListAdapter.DemoPlotReviewViewHolder> {
    ...
    public DemoPlotReviewListAdapter(Context context, ArrayList<DemoModelReviewListModel> mlist, String uid, String date, String mobilenumber, String cordinates) {
    ...
    @NonNull
    @Override
    public DemoPlotReviewListAdapter.DemoPlotReviewViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {

        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_demo_review, null);
    ...
    public void onBindViewHolder(@NonNull DemoPlotReviewViewHolder demoPlotReviewViewHolder, final int i) {
        ...
        if (!mlist.isEmpty()) {
            ...
            demoPlotReviewViewHolder.txtSowingDate.setText(demoModelReviewListModel.getSowingDate());
            ...
            demoPlotReviewViewHolder.txtCropCondition.setText(demoModelReviewListModel.getCropCondition());
            demoPlotReviewViewHolder.txtFieldObservation.setText(demoModelReviewListModel.getFieldObservation());
...
//            demoPlotReviewViewHolder.bindimage(demoPlotReviewViewHolder.imgBtn,demoModelReviewListModel.getImgPath());
    ...
    class DemoPlotReviewViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView txtAddress;
        TextView txtCropCondition;
        TextView txtFieldObservation;
        CardView cardMdo;
        ImageView imgBtn;
        ...
        DemoPlotReviewViewHolder(@NonNull View itemView) {
            ...
            txtCropCondition = (TextView) itemView.findViewById(R.id.txtCropCondition);
            txtFieldObservation = (TextView) itemView.findViewById(R.id.txtFieldObservation);
