...
public class SearchableListDialog extends DialogFragment implements
    ...
    private MySpinnerAdapter listAdapter;
    ...
    private void setData(View rootView) {
        ...
        listAdapter = new MySpinnerAdapter(getActivity(), android.R.layout.simple_list_item_1, items);        //attach the adapter to the list
...
//                _listViewItems.clearTextFilter();
            ((MySpinnerAdapter) _listViewItems.getAdapter()).getFilter().filter(null);
        } else {
