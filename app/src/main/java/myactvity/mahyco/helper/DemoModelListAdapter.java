 ...
 */
public class DemoModelListAdapter extends RecyclerView.Adapter<DemoModelListAdapter.DemoModelViewHolder> {
    ...
    public DemoModelListAdapter(Context context, ArrayList<DemoModelPlotListModel> mlist) {
    ...
    @NonNull
    @Override
    public DemoModelListAdapter.DemoModelViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
...
//                demoModelViewHolder.lblVillage.setVisibility(View.VISIBLE);
               ...
               // demoModelViewHolder.lblFocussedVillage.setVisibility(View.GONE);  mahendra 23-06-20
               // demoModelViewHolder.txtFocussedVillage.setVisibility(View.GONE);  mahenda  23-06-20
