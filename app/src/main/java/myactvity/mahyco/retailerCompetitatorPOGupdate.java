...
public class retailerCompetitatorPOGupdate extends AppCompatActivity {
    ProgressDialog pd;
    ...
    String state,dist,taluka,mktplace,RetailerMobileno,RetailerType;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_retailer_competitator_pogupdate) ;
        ...
        spCropType.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                {
                    Toast.makeText(retailerCompetitatorPOGupdate.this,ex.toString(),Toast.LENGTH_LONG).show();
                }
            ...
            public void onNothingSelected(AdapterView<?> arg0) {
                Toast.makeText(retailerCompetitatorPOGupdate.this, "gngvnv", Toast.LENGTH_LONG).show();
            }
        });
